...
var CreateUserService = /** @class */ (function () {
    ...
    CreateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, checkUserExist, hashPassword, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        userRepository = typeorm_1.getRepository(Users_1.default);
                    ...
                    case 2:
                        ...
                        user = userRepository.create({ name: name, email: email, password: hashPassword });
